...
const pieForm = (pieObj = {}) => {
  const domString = `
      <form id="pieFormForm">
        <div class="mb-3">
          <label for="name" class="form-label">Name</label>
          <input required type="text" class="form-control" value="${pieObj.name || ""}" id="name">
        </div>
        <div class="mb-3">
          <label for="ingredients" class="form-label">Ingredients</label>
          <input required type="text" class="form-control" value="${pieObj.ingredients || ""}" id="ingredients">
        </div>
        <div class="mb-3">
        <label for="bakeTemp" class="form-label">Bake Temp</label>
        <input required type="number" class="form-control" value="${pieObj.bakeTemp || ""}" id="bakeTemp">
        </div>
        <div class="mb-3">
          <label for="drinkPairing" class="form-label">Drink Pairing</label>
          <input required type="text" class="form-control" value="${pieObj.drinkPairing || ""}" id="drinkPairing">
        </div>
        <div class="mb-3">
          <label for="imageUrl" class="form-label">Image URL</label>
          <input required type="url" class="form-control" value="${pieObj.imageUrl || ""}" id="imageUrl">
        </div>
        <div class="mb-3">
          <label for="instructor" class="form-label">Instructor</label>
          <input required type="text" class="form-control" value="${pieObj.instructor || ""}" id="instructor">
        </div>
        <div class="mb-3">
          <label for="iceCream" class="form-label">Ice Cream</label>
          <input required type="text" class="form-control" value="${pieObj.iceCream || ""}" id="iceCream">
        </div>
